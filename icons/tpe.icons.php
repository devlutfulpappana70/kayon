...
var id = settings._element_id ? settings._element_id + '_sc' : 'sc_icons_'+(''+Math.random()).replace('.', ''),
        svg_bg_dir = '<?php echo trx_addons_get_svg_from_file(kayon_get_file_dir('images/decor.svg')); ?>',
        number = 0;
                                                        ...
                                                        #><span class="sc_icons_item_number"><# print(('' + number).padStart( 2, '0' )); #></span><#
                                                            ...
                                                            #><div class="sc_icons_item_header"><#
                                                                ...
                                                                #><div class="sc_icons_decoration_bg"><# print(svg_bg_dir); #></div><#
                                                                    ...
                                                                    #><div class="sc_icons_image"><img src="{{ item.image.url }}" alt="<?php esc_attr_e('Icon', 'kayon'); ?>"></div><#
                                                                        if ( settings.type == 'creative' && svg_bg_dir != '' )  {
                                                                        #><div class="sc_icons_decoration_bg"><# print(svg_bg_dir); #></div><#
                                                                            }
                                                                            } else {
								...
								render: function( html ) {
									if ( html ) {
										elementor.$previewContents.find( '#' + svg_id ).html( html );
                                                                                        ...
                                                                                        #><img class="sc_icon_as_image" src="{{ img }}" alt="<?php esc_attr_e('Icon', 'kayon'); ?>"><#
                                                                                            } else {
