                    ...
                    if (!empty($item['char']) || !empty($item['image']) || !empty($icon) || !empty( $item['title'] ) ) { ?>
                        ...
                        ?>></span><?php
                            ...
                            if (!empty($item['image'])) {
                                ...
                                ?><div class="sc_icons_image"<?php trx_addons_sc_show_attributes('sc_icons', $args, 'sc_item_wrapper'); ?>><img src="<?php echo esc_url($item['image']); ?>" alt="<?php esc_attr_e('Icon', 'kayon'); ?>"<?php echo (!empty($attr[3]) ? ' '.trim($attr[3]) : ''); ?>></div><?php
                            }
                        } else {
