...
if ( ! function_exists( 'kayon_woocommerce_get_css' ) ) {
	add_filter( 'kayon_filter_get_css', 'kayon_woocommerce_get_css', 10, 2 );
	function kayon_woocommerce_get_css( $css, $args ) {
...
$fdir = kayon_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
    require_once $fdir;
}
