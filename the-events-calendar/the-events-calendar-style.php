...
if ( ! function_exists( 'kayon_tribe_events_get_css' ) ) {
	add_filter( 'kayon_filter_get_css', 'kayon_tribe_events_get_css', 10, 2 );
	function kayon_tribe_events_get_css( $css, $args ) {
