...
Please install and activate it before starting to use the theme Kayon.
...
Theme documentation is available on https://doc.themerex.net/kayon/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Kayon is Fontello.
